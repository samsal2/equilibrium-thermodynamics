...
def redlich_kwong_calcular_compresibilidad(y, p, t):
  ...
  ----------
  y  : list[float]
    Una lista con la composición de la mezcla
  p : float
    La presión (kPa)
  t : float
    La temperatura (˚K)
...
def entalpia_ideal_metanol_ref_a_vap():
  ...
  # Se guardan globales en variables mas pequeña para uso inmediato
...
def redlich_kwong_entalpia_reducida(y, p, t):
  """
  Funcion para calcular la entalpia reducida segun la ecuación 4-64 del seader
